...
namespace MyOwnClock.Extensions
{
    ...
    DependencyProperty.RegisterAttached("MouseOverColor", typeof(Brush), typeof(CustomProperties), new PropertyMetadata(default(Brush)));
...
DependencyProperty.RegisterAttached("PressedColor", typeof(Brush), typeof(CustomProperties), new PropertyMetadata(default(Brush)));
